...
empty_set = set() # set จะไม่มีคีย์ มีแต่ เดลต้า ซึ่งเดลต้า จะซ้ำกัันไม่ได้ 

# Set with initial values 
colors = {"red", "green", "blue", "yellow"} # ใน set ห้ามซ้ำกัน
numbers = {1, 2, 3, 4, 5}
mixed_set = {1, "hello", 3.14, True}

# Set from list (removes duplicates)
list_with_duplicates = [1, 2, 2, 3, 3, 3, 4, 5] #ความพยายามในการสร้าง list ให้กลายเป็น set
